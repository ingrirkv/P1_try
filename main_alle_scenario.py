...
#    model_3.a=0
 #   model_3.b=0
   ...
   # model_3.HjelpeListe = HjelpeListe  # lager en liste


   # for i in range(5):
    #    model_3.a = model_3.a + pyo.value(HjelpeListe[i]("dual"))
     #   model_3.b = model_3.b + pyo.value(HjelpeListe[i]("obj2")) - pyo.value(HjelpeListe[i]("dual"))*pyo.value(HjelpeListe[i]("x_1"))
...
for it in range (10):
    ...
    for s in range(5):
        ...
        HjelpeListe[s] = {"obj2:": obj_2, "dual:": dual, "x_1": x_1}
